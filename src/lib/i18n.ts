...
const translations: TranslationMap = {
  ...
  "today.completeCheckin": { "zh-CN": "打卡今日", en: "Check In Today" },
  "today.checkinPrompt": { "zh-CN": "我来打卡今日学习", en: "I'm here to check in today's learning" },
  ...
  "mode.step2Label": { "zh-CN": "第二步：选择内容偏好", en: "Step 2: Choose Content Preference" },
  "mode.step3Label": { "zh-CN": "第三步：选择规划模式", en: "Step 3: Choose Planning Mode" },
  "mode.contentPrefTitle": { "zh-CN": "你喜欢哪种学习资料？", en: "What type of learning materials do you prefer?" },
  "mode.contentPrefDesc": { "zh-CN": "我会根据你的偏好推荐更多对应类型的学习资料", en: "I'll recommend more materials based on your preference" },
  "mode.contentPrefVideo": { "zh-CN": "视频为主", en: "Mostly Videos" },
  "mode.contentPrefVideoDesc": { "zh-CN": "B站、YouTube 等视频教程，生动直观", en: "Video tutorials from Bilibili, YouTube — visual and engaging" },
  "mode.contentPrefArticle": { "zh-CN": "文章为主", en: "Mostly Articles" },
  "mode.contentPrefArticleDesc": { "zh-CN": "博客、论文、文档等文字资料，深入系统", en: "Blogs, papers, docs — deep and systematic" },
  "mode.contentPrefBalanced": { "zh-CN": "均衡搭配", en: "Balanced Mix" },
  "mode.contentPrefBalancedDesc": { "zh-CN": "视频和文章各半，两种类型兼得", en: "A mix of both videos and articles" },
  "mode.backToContentPref": { "zh-CN": "返回选择内容偏好", en: "Back to Content Preference" },
  // 计划分区
  ...
  "terms.serviceDescText": { "zh-CN": "StudyAI 是一个基于 AI 的学习规划平台。我们利用人工智能技术为用户生成个性化的学习计划和建议。虽然我们努力提供高质量的指导，但学习成果最终取决于用户的执行和投入。我们使用云数据库（Neon Postgres）存储用户数据，数据可能存储在美国或欧洲的服务器上。", en: "StudyAI is an AI-powered learning planning platform. We use AI technology to generate personalized learning plans and suggestions. While we strive to provide high-quality guidance, learning outcomes ultimately depend on user execution and commitment. We use cloud database (Neon Postgres) to store user data, which may be hosted on servers in the United States or Europe." },
  ...
  "terms.useRestrictionsText": { "zh-CN": "您同意不会：(a) 将服务用于任何非法目的；(b) 尝试干扰或破坏服务；(c) 未经授权访问服务的任何部分；(d) 利用 AI 生成侵犯他人著作权或知识产权的内容。", en: "You agree not to: (a) use the service for any illegal purpose; (b) attempt to interfere with or disrupt the service; (c) access any part of the service without authorization; (d) use AI to generate content that infringes on others' copyright or intellectual property rights." },
  "terms.intellectualProperty": { "zh-CN": "知识产权", en: "Intellectual Property" },
  "terms.intellectualPropertyText": { "zh-CN": "StudyAI 的名称、标志、界面设计和代码均为我们的知识产权。AI 生成的学习计划内容归用户所有。学习资料中的外部链接和资源归各自权利人所有。", en: "The StudyAI name, logo, interface design, and code are our intellectual property. AI-generated learning plan content belongs to the user. External links and resources in learning materials belong to their respective rights holders." },
  ...
  "privacy.dataStorage": { "zh-CN": "数据存储与跨境传输", en: "Data Storage & Cross-Border Transfer" },
  "privacy.dataStorageText": { "zh-CN": "您的数据存储在 Neon Postgres 云数据库中，使用业界标准的加密传输和静态加密保护。数据库服务器可能位于美国或欧洲，即您的数据可能会被传输到您所在国家/地区以外的服务器。我们采取合理的技术和组织措施保护您的数据安全。使用本服务即表示您同意此数据跨境传输安排。", en: "Your data is stored in Neon Postgres cloud database, protected with industry-standard encryption in transit and at rest. Database servers may be located in the United States or Europe, meaning your data may be transferred to servers outside your country of residence. We take reasonable technical and organizational measures to protect your data security. By using this service, you consent to this cross-border data transfer arrangement." },
  "privacy.cookies": { "zh-CN": "Cookie 与追踪技术", en: "Cookies & Tracking" },
  "privacy.cookiesText": { "zh-CN": "我们使用必要的 Cookie 来维持您的登录状态和语言偏好。此外，我们使用 Vercel Analytics 收集匿名的页面访问统计数据（不包含个人身份信息），以帮助我们了解服务使用情况并优化用户体验。我们不会使用 Cookie 进行广告投放或用户行为追踪。", en: "We use essential cookies to maintain your login state and language preferences. Additionally, we use Vercel Analytics to collect anonymous page visit statistics (without personally identifiable information) to help us understand service usage and improve user experience. We do not use cookies for advertising or behavioral tracking." },
  ...
  "privacy.gdpr": { "zh-CN": "GDPR 合规（欧盟用户）", en: "GDPR Compliance (EU Users)" },
  "privacy.gdprText": { "zh-CN": "对于欧盟用户，我们依据 GDPR 第 6(1)(a) 条（用户同意）和第 6(1)(f) 条（合法利益）处理您的个人数据。您有权：(a) 请求访问、更正或删除您的个人数据；(b) 限制或反对数据处理；(c) 数据可携带权；(d) 随时撤回同意。如需行使上述权利，请通过邮件联系我们。", en: "For EU users, we process your personal data under Article 6(1)(a) (consent) and Article 6(1)(f) (legitimate interests) of GDPR. You have the right to: (a) request access, correction, or deletion of your data; (b) restrict or object to processing; (c) data portability; (d) withdraw consent at any time. Contact us by email to exercise these rights." },
  "privacy.pipl": { "zh-CN": "个人信息保护合规（中国用户）", en: "PIPL Compliance (China Users)" },
  "privacy.piplText": { "zh-CN": "我们遵守《中华人民共和国个人信息保护法》的相关规定。我们仅在提供服务所必需的范围内收集和使用您的个人信息，并采取必要措施保障信息安全。您有权查阅、更正、删除您的个人信息，以及注销账户。如涉及向境外提供个人信息，我们将按照法律法规的要求进行。", en: "We comply with the Personal Information Protection Law of the People's Republic of China. We collect and use your personal information only to the extent necessary to provide services, and take necessary measures to safeguard information security. You have the right to access, correct, delete your personal information, and deactivate your account. Cross-border data transfers are conducted in accordance with applicable laws and regulations." },
