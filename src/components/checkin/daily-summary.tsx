      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-base text-zinc-900 dark:text-white">今日已完成</CardTitle>
          </div>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-3">
          <div className="flex flex-col items-center gap-1 p-3 rounded-xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/[0.04] dark:border-white/[0.04]">
            ...
            <span className="text-[10px] text-zinc-400 dark:text-zinc-500">完成率</span>
          </div>
          <div className="flex flex-col items-center gap-1 p-3 rounded-xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/[0.04] dark:border-white/[0.04]">
            ...
            <span className="text-[10px] text-zinc-400 dark:text-zinc-500">专注度</span>
          </div>
          <div className="flex flex-col items-center gap-1 p-3 rounded-xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/[0.04] dark:border-white/[0.04]">
            ...
            <span className="text-[10px] text-zinc-400 dark:text-zinc-500">状态</span>
          </div>
        </div>
        ...
        {checkin.feedback.summary && (
          <div className="p-3 rounded-xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/[0.04] dark:border-white/[0.04]">
            <p className="text-xs text-zinc-400 dark:text-zinc-500 mb-1">今日总结</p>
